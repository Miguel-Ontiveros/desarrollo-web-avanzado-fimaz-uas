...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($nombre === "" || $apellido === "" || $correo === "") {
        ...
        try {
            ...
            $sqlAlumnos = "INSERT INTO alumnos (nombre, apellido, correo) VALUES (:nombre, :apellido, :correo)";
            ...
            if ($simularError) {
                ...
                $sqlLog = "INSERT INTO log (id_alumno, accion) VALUES (:id_alumno, :accion)";
            ...
            $pdo->commit();
            $mensaje = "Transaccion confirmada (COMMIT). Alumno registradio con ID: $idAlumno";
        } catch (Exception $e) {
...
<body>
    ...
    <div class="card">
        ...
        <?php if ($mensaje): ?>
            ...
            <?php if ($detalle): ?>
                <p class="small danger">Detalle (solo desarrollo):<?= htmlspecialchars($detalles) ?></p>
            <?php endif; ?>
        <?php endif; ?>
    </div>
            ...
            <table>
                ...
                <?php foreach ($logs as $l): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($l['id_alumno']) ?></td>
